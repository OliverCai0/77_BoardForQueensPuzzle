...
public class BoardForQueensPuzzle {
    ...
    public boolean lastIsNg() {
      for(int rank = 0; rank < lastRankFilled; rank ++){
        int difference = lastRankFilled - rank;
        if(filesWithQueens[lastRankFilled] == filesWithQueens[rank] 
           || difference + filesWithQueens[rank]
              == filesWithQueens[lastRankFilled]
           || filesWithQueens[rank] - difference
           == filesWithQueens[lastRankFilled]) return true;
      }
        return false;
    }
    ...
    public boolean accept() {
        //if(filesWithQueens.length == 2 && lastRankFilled == 1) return true;
       // if(filesWithQueens.length == 3 && lastRankFilled == 2) return true;
        //else 
        return !lastIsNg();
    }
